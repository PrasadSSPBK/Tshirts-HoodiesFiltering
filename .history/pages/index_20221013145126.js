    ...
    <section className="text-gray-600 body-font" >
      <div className="container flex px-5 py-24 mx-auto w-full">
        ...
        <div className="w-1/4 mx-5 shadow-2xl">
          {sizeArray.map((item) => {
            return (
              <div key={item} className=" mx-5 my-4 px-2">
                <input type="checkbox" value={item} id="size"  />
                <span htmlFor="size">₹{item}</span>
              </div>
            )
          })}
        </div>
