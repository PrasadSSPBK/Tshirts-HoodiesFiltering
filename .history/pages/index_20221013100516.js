...
export default function Home({ data, shirts }) {
  // console.log(data)
        ...
        <div className="w-3/4 flex flex-wrap -m-4">
          ...
          {Object.keys(products).map((item) => {
            return (
              ...
              <div key={products[item].id} className="lg:w-1/3 md:w-1/2 p-4 w-full">
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-1 font-semibold text-red-600">₹{products[item].color}</p>
                </div>
              </div>
