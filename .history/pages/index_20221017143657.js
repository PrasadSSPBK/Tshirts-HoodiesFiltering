          ...
          <div className="  m-5 shadow-2xl rounded">
            ...
            {(categoryArray).map((item) => {
              return (
                ...
                <div  className="flex mx-5 my-4 px-2">
                  <p  className="font-semibold mx-2 text-red-600 cursor-pointer" >{item.toUpperCase()}</p>
            ...
            return (
              ...
              <div key={item.id} className="w-1/4 m-2 shadow-xl  content-center p-4 ">
                ...
                <div className="mt-4">
                  ...
                  <div>
                      <p className={`mr-3 text-${item.color}-700 text-sm font-semibold`}>Color Available: {item.color.toUpperCase()}</p>
